...
const muted = "#3d2e4a"
const land = "#0d8a72"
const landStroke = "#111111"
const ocean = "#f5d23a"
const ok = "#0d8a72"
const bad = "#d4202a"
const svo = "#6b3aa0"
const panel = "#ffffff"
const ui = `"Fraunces", "Iowan Old Style", Georgia, serif`
...
const worldLand = `
  <g fill="${land}" stroke="${landStroke}" stroke-width="1.6" stroke-linejoin="miter">
...
function legend(items: { color: string; label: string }[], x = 16, y = 158): string {
  return items
    .map((item, i) => {
      const dx = x + i * 72
      return `<circle cx="${dx}" cy="${y}" r="5" fill="${item.color}" stroke="${ink}" stroke-width="1.4"/><text x="${dx + 10}" y="${y + 4}" fill="${ink}" font-size="11" font-family="${ui}">${item.label}</text>`
    })
    .join("")
}
...
export const hubArt: Record<HubArtId, string> = {
  atlas: frame(
    ...
    `
    <rect width="320" height="176" rx="2" fill="${ocean}"/>
    ${worldLand}
    <g fill="${ink}">
    ...
    <rect x="12" y="12" width="92" height="22" rx="2" fill="${panel}" stroke="${ink}" stroke-width="1.4"/>
  ...
  sunburst: frame(
    ...
    <g transform="translate(188,28) scale(0.42)">
      <rect width="320" height="176" rx="4" fill="${panel}" stroke="${ink}" stroke-width="3"/>
  ...
  dossier: frame(
    ...
    `
    <rect width="320" height="176" rx="2" fill="${ocean}"/>
    <rect x="12" y="16" width="118" height="144" rx="2" fill="${panel}" stroke="${ink}" stroke-width="1.4"/>
    ...
    <text x="24" y="92" fill="${ink}" font-size="12" font-family="${ui}">WALS  7</text>
    <text x="24" y="112" fill="${ink}" font-size="12" font-family="${ui}">Grambank  180</text>
  ...
  compare: frame(
    ...
    `
    <rect width="320" height="176" rx="2" fill="${ocean}"/>
    <text x="24" y="28" fill="${ink}" font-size="12" font-family="${ui}">K'iche'</text>
    <text x="168" y="28" fill="${ink}" font-size="12" font-family="${ui}">Kaqchikel</text>
    ...
    <rect x="16" y="128" width="288" height="32" rx="2" fill="${panel}" stroke="${ink}" stroke-width="1.2"/>
  ...
  investigate: frame(
    ...
    <g transform="translate(214,18)">
      <rect width="92" height="86" rx="2" fill="${panel}" stroke="${ink}" stroke-width="1"/>
  ...
  learn: frame(
    ...
    `
    <rect width="320" height="176" rx="2" fill="${ocean}"/>
    <rect x="16" y="20" width="88" height="88" rx="2" fill="${panel}" stroke="${ink}" stroke-width="1.4"/>
    <text x="28" y="44" fill="${ink}" font-size="13" font-family="${ui}">1</text>
    <text x="28" y="68" fill="${ink}" font-size="12" font-family="${ui}">terms</text>
    <text x="28" y="88" fill="${muted}" font-size="10" font-family="${ui}">glossary</text>
    <rect x="116" y="44" width="88" height="88" rx="2" fill="${panel}" stroke="${rust}" stroke-width="1.4"/>
    <text x="128" y="68" fill="${rust}" font-size="13" font-family="${ui}">2</text>
    <text x="128" y="92" fill="${ink}" font-size="12" font-family="${ui}">K'iche'</text>
    <text x="128" y="112" fill="${muted}" font-size="10" font-family="${ui}">dossier</text>
    <rect x="216" y="20" width="88" height="88" rx="2" fill="${panel}" stroke="${svo}" stroke-width="1.4"/>
    <text x="228" y="44" fill="${svo}" font-size="13" font-family="${ui}">3</text>
    <text x="228" y="68" fill="${ink}" font-size="12" font-family="${ui}">map</text>
  ...
  notebook: frame(
    ...
    `
    <rect width="320" height="176" rx="2" fill="${ocean}"/>
    <rect x="18" y="22" width="168" height="118" rx="2" fill="${panel}" stroke="${ink}" stroke-width="1.6"/>
    ...
    <text x="32" y="120" fill="${ink}" font-size="11" font-family="${ui}">Latin · LTR</text>
    <rect x="204" y="36" width="96" height="88" rx="2" fill="${panel}" stroke="${ink}" stroke-width="1.4"/>
  ...
  sprachbund: frame(
    ...
    <text x="210" y="92" fill="${ink}" font-size="11" font-family="${ui}">three families</text>
    <text x="210" y="110" fill="${ink}" font-size="11" font-family="${ui}">one shared trait</text>
  ...
  pair: frame(
    ...
    `
    <rect width="320" height="176" rx="2" fill="${ocean}"/>
    <rect x="24" y="28" width="112" height="88" rx="2" fill="${panel}" stroke="${ink}" stroke-width="1.8"/>
    <rect x="184" y="28" width="112" height="88" rx="2" fill="${panel}" stroke="${rust}" stroke-width="1.8"/>
